...
def get_default_directions():
    return {
        'smile': os.path.join('latent_directions', 'smile.npy'),
        'age': os.path.join('latent_directions', 'age.npy'),
        'gender': os.path.join('latent_directions', 'gender.npy'),
        'yaw': os.path.join('latent_directions', 'yaw.npy'),
        'pitch': os.path.join('latent_directions', 'pitch.npy'),
    }
